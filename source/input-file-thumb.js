...
/*
    ...
    $(document).ready(function() {
        $(':file').inputFileThumb({
            ...
            'cbDelete'              : null, // A callback function called when the user clicks on the Delete file. The function's context is the instance of InputFileThumb object. The function must return true if you want to continue the delete process.
            'cbChange'              : null // A callback function called when the input[type=file] change. The function's context is the instance of InputFileThumb object.
        });
    });
*/
    ...
    function InputFileThumb(input, options) {
        ...
        this.input      = $(input).change(function(e) {
            object.modify();
            object.hide();
            if ($.isFunction(object.options.cbChange)) {
                object.options.cbChange.call(object);
            }
        }).click(function(e) {
        ...
        if (this.options.deleteInput) {
            ...
            this.deleteFile  = $('<span class="deleteFile">' + this.options.delTitle + '</span>').appendTo(this.fileActions).click(function(e) {
                ...
                if ($.isFunction(object.options.cbDelete)) {
                    if (!object.options.cbDelete.call(object)) {
                        return false;
                    }
                }
                object.remove();
